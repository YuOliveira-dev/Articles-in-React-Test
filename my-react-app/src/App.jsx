      ...
      <>
        ...
        <section id="articles">
          <Article
            ...
            provider="NASA"
            description="Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo laudantium est blanditiis ipsa accusantium, repellat cum molestias inventore eum, iure minus fugit obcaecati adipisci odio at, nostrum unde autem ratione."
            image={ArticleImg1}
          />

          <Article
            title="Vibrant Portraits of 200"
            provider="SpaceNews"
            description="Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo laudantium est blanditiis ipsa accusantium, repellat cum molestias inventore eum, iure minus fugit obcaecati adipisci odio at, nostrum unde autem ratione."
            image={ArticleImg2}
          />
